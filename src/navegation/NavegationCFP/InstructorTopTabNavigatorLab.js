    ...
    return (
        <Tab.Navigator
            screenOptions={{
                ...
                tabBarStyle: { position: 'absolute', top: StatusBar.currentHeight , left: 4, right: 0, backgroundColor: '#FCBE2D' } // Mueve el tabBar a la parte superior
            }}>
